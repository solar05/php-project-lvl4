...
<head>
    ...
    <title>{{ config('app.name', 'Task_Manager') }}</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('login') }}">{{ trans('account.sign_in') }}</a>
                            </li>
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('register') }}">{{ trans('account.register') }}</a>
                                </li>
                            @endif
                        @else
                            ...
                            <a id="status" class="nav-link label-primary label" href="{{ route('statuses.index') }}" role="button" aria-haspopup="true" aria-expanded="false" v-pre>{{ trans('state.name') }}</a>
                        @endguest
